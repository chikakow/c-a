...
export class GeneraterefundsComponent implements OnInit {
    ...
    fillDropdowns() {
        ...
        this.refershIntervalValue = Object.keys(this.refershIntervalValue).map
            (key => ({
                text: key,
                value: this.refershIntervalValue[key]
            }));
    ...
    sourceFilterData(text, value) {
        ...
        this.preferences = this.siteService.getAngularJson().atsServerValues.userPreferences.refundsmanagement
